...
class BrowserExtensionContractTest(unittest.TestCase):
    ...
    def test_popup_supports_background_review_page_collector(self):
        ...
        for marker in [
            ...
            "click_reuse_debug",
            "amazonLoadMoreCandidateDiagnostics",
            "no_reusable_load_more_choice",
            "chosen_click_choice",
            "load_more_candidate_count",
            "after_load_more_candidate_count",
            "after_product_collected",
            "afterProduct",
            "next_url_after_click",
            "next_url_after_click_source",
            "after_product_url",
            "clicked_url",
            "click_result_before_visible_review_count",
            "NAVIGATE_CLICK_REUSE_MIN_NEW_REVIEWS",
            "reviewIdentityKeySetFromProduct",
            "uniqueReviewDeltaCount",
            "amazonLoadMoreClickContextKey",
            "reusableAmazonLoadMoreChoice",
            "attemptNavigateClickReuse",
            "current_page_load_more",
            "visitedLoadMoreClickContexts",
            "added_unique_reviews",
            "insufficient_new_reviews",
