...
Document: docs/language_mode_public_refresh_final_audit.md

???

- Language Mode public refresh ???
- Public Demo ??? English / ?? selector
- Product Description Mode ??????
- Stable slug Product Mode ??????
- output_language=zh-CN ??
- Feedback / Waitlist ??
...
Document: docs/language_mode_heading_encoding_final_audit.md
...
Document: docs/language_mode_trial_launch_checklist.md
...
Document: docs/language_mode_trial_outreach_tracker.md
...
- ?? Language Mode ??????????????
- ?? 5 ???? 3 ????? + 2 ?????
- ???????? Language selector???????????? feedback????? waitlist
...
Document: docs/language_mode_trial_smoke_record.md
...
Document: docs/language_mode_trial_round_1_summary_template.md
...
- ?? Language Mode ?????????????
- ?????????? docs/language_mode_trial_round_1_summary.md
- ????????????????? UI?Product Description ?????Amazon Beta ? waitlist follow-up
...
Document: docs/language_mode_trial_launch_final_audit.md
...
## L13.9-A / L14.0-A / L14.0-B Roadmap Batch
...
- docs/trial_feedback_deferred_roadmap_decision.md
- docs/pasted_reviews_input_design.md
- docs/pasted_reviews_api_contract_design.md
...
## L14.0-C / L14.0-D / L14.0-E Pasted Reviews Planning Batch
...
- docs/pasted_reviews_frontend_ux_design.md
- docs/pasted_reviews_implementation_plan.md
- docs/pasted_reviews_boundary_checklist.md

???

- Pasted Reviews Mode ?? UX ???
- ???????
- ?????????
- ????????? endpoint ??
- ?????????? endpoint ??? UI ??
...
## L14.4-A / L14.4-B / L14.4-C Pasted Reviews Trial Batch
...
- docs/pasted_reviews_trial_launch_checklist.md
- docs/pasted_reviews_trial_outreach_tracker.md
- docs/pasted_reviews_trial_round_1_summary_template.md
...
- docs/trial_round_1_execution_record.md
...
## L17.0-B / C / D / E / F Trial Round 1 Execution Pack
...
- docs/trial_round_1_send_log.md
- docs/trial_round_1_feedback_inbox.md
- docs/trial_round_1_daily_review_checklist.md
- docs/trial_round_1_completion_criteria.md
- docs/trial_round_1_v1_archive.md

Tag:

trial-round-1-execution-v1

???

- ??? trial outreach ???????? inbox?????????????
- ??????????? 5 ?

## L17.1-A / B / C / D / E / F Chinese Onboarding Feedback Batch
...
- docs/trial_round_1_simulated_feedback_record.md
- docs/chinese_onboarding_localization_decision.md
- docs/chinese_onboarding_flow_plan.md
- docs/dataset_language_gap_observation.md
- docs/chat_guided_input_idea_note.md
- docs/l17_1_next_implementation_plan.md

???

- ?? trial feedback ???
- ????????? onboarding / localization / dataset language gap
- Chat guided input ??????????????
...
## L18.0-A / B / C / D / E / F / G Frontend UX Redesign Planning
...
- docs/frontend_ux_redesign_brief_l18.md
- docs/frontend_ux_user_journey_l18.md
- docs/frontend_ux_new_layout_spec_l18.md
- docs/frontend_ux_component_plan_l18.md
- docs/frontend_ux_result_placement_spec_l18.md
- docs/frontend_ux_codex_prompt_l18.md
- docs/frontend_ux_boundary_checklist_l18.md
