...
Add-Check "project_workspace_control_center_marker" ($page.Content -match "Project Workspace control center bundle")
Add-Check "project_workspace_agent_run_ledger_marker" ($page.Content -match "Project Workspace agent run ledger bundle")
...
Add-Check "project_workspace_provider_failure_taxonomy_marker" ($page.Content -match "Project Workspace provider failure taxonomy bundle")
Add-Check "project_workspace_provider_asset_contract_marker" ($page.Content -match "Project Workspace provider asset contract bundle")
Add-Check "project_workspace_provider_cost_quota_risk_guard_marker" ($page.Content -match "Project Workspace provider cost quota risk guard bundle")
...
Add-Check "project_workspace_provider_invocation_audit_packet_marker" ($page.Content -match "Project Workspace provider invocation audit packet bundle")
Add-Check "project_workspace_review_evidence_quality_marker" ($page.Content -match "Project Workspace review evidence quality bundle")
...
Add-Check "project_workspace_claim_safe_delivery_qa_marker" ($page.Content -match "Project Workspace claim-safe delivery QA bundle")
Add-Check "project_workspace_claim_safe_delivery_remediation_marker" ($page.Content -match "Project Workspace claim-safe delivery remediation bundle")
Add-Check "project_workspace_claim_safe_remediation_verification_marker" ($page.Content -match "Project Workspace claim-safe remediation verification bundle")
Add-Check "project_workspace_final_claim_safe_export_packet_marker" ($page.Content -match "Project Workspace final claim-safe export packet bundle")
...
Add-Check "project_workspace_mvp_consolidation_marker" ($page.Content -match "Project Workspace MVP consolidation bundle")
...
Add-Check "project_workspace_phase2_sandbox_contract_test_matrix_marker" ($page.Content -match "Project Workspace phase2 sandbox contract test matrix bundle")
Add-Check "project_workspace_phase2_sandbox_readiness_review_marker" ($page.Content -match "Project Workspace phase2 sandbox readiness review bundle")
